...
export const Item=({
    ...
    const onCreate=(
        ...
        event?.stopPropagation();
        if(!id) return;
        const promise= create({title:'No title',parentDocument:id})
        .then((documentID)=>{
            if(!expanded){
                onExpand?.();
    ...
    return(
        ...
        active && "bg-primary/5 text-primary")}>
            ...
            {documentIcon ? (
                ...
                <Icon className="shrink-0 h-18[px]mr-2 text-muted-foreground
               "/>
            ...
            {isSearch && (
                ...
                select-none items-center gap-1 rounded border bg-mutedpx-1.5 font-mono text-[10px] font-medium
